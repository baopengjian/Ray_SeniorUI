...
public class MainActivity extends AppCompatActivity {
    ...
    static Class[] TARGETS = {SeniorUI01_DrawingProcessActivity.class,
            ...
            SeniorUI04_ShaderZoomActivity.class, SeniorUI04_LinearGradientActivity.class,SeniorUI04_GradientActivity.class, SeniorUI05_InvertedImageActivity.class, SeniorUI04_RadarActivity.class, SeniorUI04_RippleActivity.class};
