...
public class MainActivity extends AppCompatActivity {
    ...
    static Class[] TARGETS = {SeniorUI01_DrawingProcessActivity.class,
            ...
            SeniorUI04_ShaderZoomActivity.class, SeniorUI04_LinearGradientActivity.class,SeniorUI04_GradientActivity.class, SeniorUI04_InvertedImageActivity.class, SeniorUI04_RadarActivity.class, SeniorUI04_RippleActivity.class};
    static String[] TARGETS_DESC = {"01_UI绘制流程应用_底部弹出",
            ...
            "04_BitmapShader:放大镜","04_LinearGradient:霓虹灯文字","04_环形渲染、梯度渲染、组合渲染","04_倒影效果","04_雷达图","04_水波纹效果"};
